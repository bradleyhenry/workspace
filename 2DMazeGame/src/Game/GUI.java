...
public class GUI implements MouseListener,KeyListener {
	...
	JLabel lifeLabel = new JLabel("Life:"+Integer.toString(life));
	JLabel battleHealthLabel = new JLabel("Health:"+Integer.toString(health));
	JLabel battleLifeLabel = new JLabel("Life:"+Integer.toString(life));
	
	
	//////battle
	JFrame battle = new JFrame("Battle");
	JPanel battleMainPanel = new JPanel(new GridLayout(3,3,1,1));
	...
	JLabel heroBattle = new JLabel(new ImageIcon("src//image//hero.png"));
	int marioX = 0;
	int marioY = 0;
	//
	JLabel[] villian = new JLabel[15];
	String[][] contents = new String[15][15];
	JLabel villianBattle = new JLabel(new ImageIcon("src//image//villian.png"));
	...
	public void battle(){
		battleMainPanel.add(heroBattle);
		battleMainPanel.add(villianBattle);
		battleMainPanel.add(battleHealthLabel);
		battleMainPanel.add(battleLifeLabel);
		battleMainPanel.add(fight);
		battleMainPanel.add(run);
		battle.add(battleMainPanel);
	...
	public void lifeCheck(){
		int quit = JOptionPane.showConfirmDialog(null,"You Fail/nExit Game?");
		mainPanel.removeAll();
		mainPanel.setBackground(Color.RED);
		if(quit == 0){
			System.exit(0);
